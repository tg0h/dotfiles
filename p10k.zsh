# Generated by Powerlevel10k configuration wizard on 2020-08-30 at 11:39 +08.
...
() {
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|terraform|pulumi|abc|cget|as'
  ...
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
      ...
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_AWS_PROD_FOREGROUND=093
  typeset -g POWERLEVEL9K_AWS_PROD_BACKGROUND=220

  typeset -g POWERLEVEL9K_AWS_DEFAULT_FOREGROUND=000
