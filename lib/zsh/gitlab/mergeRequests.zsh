function ggmr() {
  ...
  while getopts 'lv' opt; do
    ...
    #if long 
  [[ -n $long ]] && https $verbiage $GITLAB_URL/projects/$GITLAB_PROJECT_ID/merge_requests/$1 \
...
EOF
    ...
    #if short
  [[ -z $long ]] && https $verbiage $GITLAB_URL/projects/$GITLAB_PROJECT_ID/merge_requests/$1 \
