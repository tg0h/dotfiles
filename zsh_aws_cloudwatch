...
ddget --tableName="Argus-Settings-$_ARGUS_DD_SUFFIX" \
    ...
    --expressionAttributeValues='{":accountId":"'$accountId'", ":organizationId": "'$organizationId'"}' 
}
...
#tim 10M
# TODO: combine all tasks method into 1 function
# TODO: add projection
# TODO: add projection
# TODO: add time between
