...
map("n", "<M-C-G>", ":lua require('harpoon.ui').nav_file(5)<CR>", default_options)
map("n", "<M-C-C>", ":lua require('harpoon.ui').nav_file(6)<CR>", default_options)
map("n", "<M-C-R>", ":lua require('harpoon.ui').nav_file(7)<CR>", default_options)
map("n", "<M-C-L>", ":lua require('harpoon.ui').nav_file(8)<CR>", default_options)
