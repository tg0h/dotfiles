...
vim.keymap.set('n', '<A-q>', ":lua require('tg.quickfix').ToggleQFList(1)<CR>", { desc = 'toggle quickfix list' })
vim.keymap.set('n', '<S-A-;>', ":lua require('tg.quickfix').ToggleQFList(0)<CR>", { desc = 'toggle loclist' })
vim.keymap.set('n', '<A-j>', ':cnext<CR>', { desc = 'next quickfix item' })
vim.keymap.set('n', '<A-k>', ':cprev<CR>', { desc = 'previous quickfix item' })
